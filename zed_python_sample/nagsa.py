    ...
    while key != 113:  # for 'q' key
        ...
        if err == sl.ERROR_CODE.SUCCESS:
            ...
            for detection in detections:
                ...
                #depth_image_3d = np.dstack((depth_ocv,depth_ocv,depth_ocv,depth_ocv)+
                depth_ocv = depth_zed.get_data()#+
                pixel_long = depth_ocv /719
                x_side = int(bounds[0] + bounds[2]) #+
                y_side = int(bounds[1] + bounds[3])#+
                if x_side >719:
                    x_side = 719
                if y_side > 700:
                    y_side = 700
                ...
                print(x_side)
                real_distance_x = pixel_long[x_side] - pixel_long[10]
                real_distance_y = pixel_long[y_side] - pixel_long[10]
                print(real_distance_x)
                print(real_distance_y)
                ...
                cv2.putText(image, label + " " +  (str(real_distance_x) + " m"),
